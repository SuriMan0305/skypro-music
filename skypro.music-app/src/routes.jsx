...
export const AppRoutes = ({playerVision, setPlayerVision, info, setInfo}) => {
  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute isAllowed={localStorage.getItem('token') === 'true' ? true : false}/>} >
        <Route path="/" element={<Main playerVision={playerVision} setPlayerVision={ setPlayerVision } info={ info } setInfo={setInfo}/>}>
        </Route>
